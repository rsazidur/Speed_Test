...
label = Label(sp, text="Internet Speed Test", font=("serif", 20, "bold"))
...
down_label = Label(sp, text="00", font=("serif", 20))
...
up_label = Label(sp, text="00", font=("serif", 20))
label.place(x=60, y=360, height=50, width=380)

button = Button(sp, text="Check Speed", font=("serif", 20), relief=RAISED, bg="Gray", command=speedcheck)
